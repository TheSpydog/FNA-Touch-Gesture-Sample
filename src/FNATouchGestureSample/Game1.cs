...
namespace FNATouchGestureSample
{
	public class Game1 : Microsoft.Xna.Framework.Game
	{
		...
		protected override void Initialize()
		{
			...
			Console.WriteLine("NOTE: Press D to swap between Horizontal/Vertical Dragging and Free Dragging.");
		...
		protected override void Update(GameTime gameTime)
		{
			...
			// Handle switching drag types...
			KeyboardState currKeyboardState = Keyboard.GetState();
			if (currKeyboardState.IsKeyDown(Keys.D) && prevKeyboardState.IsKeyUp(Keys.D))
			{
				// If free drag is enabled
				if ((TouchPanel.EnabledGestures & GestureType.FreeDrag) != 0)
				{
					Console.WriteLine("Switching to H/V dragging...");
				...
				{
					Console.WriteLine("Switching to free dragging...");
					TouchPanel.EnabledGestures |= GestureType.FreeDrag;
					TouchPanel.EnabledGestures &= ~GestureType.HorizontalDrag;
					TouchPanel.EnabledGestures &= ~GestureType.VerticalDrag;
				}
		...
		private void HandleTouchInput()
		{
			...
			while (TouchPanel.IsGestureAvailable)
			{
				...
				switch (gesture.GestureType)
				{
					...
					// These have been added just to show how these gestures work. -Caleb
